...
(function() {
  ...
  function sequoiaTreeDirective(Tree, BUTTONS, NODE_TEMPLATE){
  ...
  sequoiaTreeDirective.$inject = ['SequoiaTree', 'BUTTONS', 'NODE_TEMPLATE'];
